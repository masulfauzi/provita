                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <form action="{{ route('jenisrekening.index') }}" method="get">
                                ...
                                <div class="col-2">
                                    {!! button('jenisrekening.create', $title) !!}  
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mb-2">
								...
								<td>Kode Jenis Rekening</td>
									...
									<td>{{ $item->kode_jenis_rekening }}</td>
									
                                                <td>
                                                    {!! button('jenisrekening.show','', $item->id) !!}
                                                    {!! button('jenisrekening.edit', $title, $item->id) !!}
                                                    {!! button('jenisrekening.destroy', $title, $item->id) !!}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
