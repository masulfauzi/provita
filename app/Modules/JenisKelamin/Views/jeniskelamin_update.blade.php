                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" action="{{ route('jeniskelamin.update', $jeniskelamin->id) }}" method="POST">
                                <div class="form-body">
                                    @csrf @method('patch')
                                    ...
                                    <div class="offset-md-3 ps-2">
                                        ...
                                        <a href="{{ route('jeniskelamin.index') }}" class="btn btn-secondary">Batal</a>
                                    </div>
                                </div>
                            </form>
                        </div>
